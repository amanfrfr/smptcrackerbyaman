...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct @am4n.py AS u LIKE !\033[00m")
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by @am4n.py [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Email :</font> amansuperman02@gmail.com <br><br></font>
...
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.) 
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
               \033[91m[\033[92m+\033[91m]\033[1m(C)opyright > Github.com/amanfrfr\033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V2.1 DEVEL BY @am4n.py \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m     EMail : amansuperman02@gmail.com   \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m Facebook >  https://www.fb.com/inactive \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Youtube > youtube.com/codewithaman  \033[91m[\033[92m+\033[91m]''')
